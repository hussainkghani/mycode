...
def main():
    #runtime function
    quotes = {
            "Fry": ["Shut up and take my money!", "Wait I'm having one of those things, you know, a headache with pictures",
            "I'm never gonna get used to the 31st century. Caffeinated bacon? Baconated grapefruit? Admiral Crunch?"],
            "Bender": ["I hope he didn't die. Unless he left a notes naming me his sucessor, then I hope he did die", 
            ...
            "Prof Farnsworth": ["God didn't get to be God by giving away money!", "I was born in prison and I'll die in prison.",
...
#maybe add episode where the quote appears 
